        ...
        <nav className="mx-auto px-6">
            ...
            <ul className="text-xs font-normal text-gray-400 max-w-[50%] flex items-center gap-3">
                <li className="inline-block mr-2">
                    ...
                    <Link target="_blank" rel="noopener noreferrer" href = "https://twitter.com/ZaarNFT">
                        <svg width="16" height="16" fill="none" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path d="M9.14163 7.19284L13.6089 2H12.5503L8.67137 6.50887L5.57328 2H2L6.68492 8.81821L2 14.2637H3.05866L7.15491 9.50218L10.4267 14.2637H14L9.14137 7.19284H9.14163ZM7.69165 8.87828L7.21697 8.19934L3.44011 2.79694H5.06615L8.11412 7.15685L8.5888 7.83579L12.5508 13.503H10.9248L7.69165 8.87854V8.87828Z" fill="#B1B5C4"></path></svg>
                    </Link>
                    </li>
               
                <li className="inline-block">
                {/* Placeholder for Discord icon */}
                    <Link target="_blank" rel="noopener noreferrer" href="https://discord.gg/kSjrBEGnmf">
                ...
                <li className="inline-block">
                {/* Placeholder for Discord icon */}
                    <Link target="_blank" rel="noopener noreferrer" href="https://gitbook.protectorate.xyz/">
                        <div className = "text-#B1B5C4">Docs</div>
                    </Link>
                </li>
            </ul>
