          ...
          <ul className="text-xs font-normal text-gray-400 max-w-[50%] flex items-center gap-3">
            <li className="inline-block mr-2">
              ...
              <Link
                ...
                href="https://twitter.com/ZaarNFT"
              >
                <svg
                  width="16"
                  height="16"
            ...
            <li className="inline-block">
              ...
              <Link
                target="_blank"
                rel="noopener noreferrer"
                href="https://discord.gg/kSjrBEGnmf"
              >
                <svg
                  width="16"
                  height="16"
            ...
            <li className="inline-block">
              ...
              <Link
                target="_blank"
                rel="noopener noreferrer"
                href="https://gitbook.protectorate.xyz/"
              >
                <div className="text-#B1B5C4 hover:text-hoveryellow">Docs</div>
              </Link>
            </li>
            <li className="inline-block">
              <Link
              ...
              >
                <div className="text-gray  hover:text-hoveryellow transform   ">
                  Telegram Trading
                </div>
              </Link>
            </li>
