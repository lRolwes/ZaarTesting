...
export const TopSection = () => {
    ...
    return(
        <div className="w-full z-50 h-[250px] md:h-[220px] mt-[50px]">
            {/* top section */}
            ...
            <div className="container-fluid mx-auto flex flex-col sm:flex-row justify-center items-center ml-4 sm:ml-0 pl-0 sm:pl-4 py-6 pt-4 pb-0">
                ...
                <div className="flex flex-col justify-center items-center ml-0 sm:m-0">
                    ...
                    <div className="flex flex-col text-xs items-center justify-center">
                        ...
                        <div className="flex flex-row items-center justify-center w-1/3 max-w-20 sm:w-auto mb-2 sm:mb-0 mr-0 sm:mr-6 space-x-1">
                        ...
                        <div className="text-center justify-between w-full  sm:w-auto mb-2 sm:mb-0 mr-0 sm:mr-6 text-white">
