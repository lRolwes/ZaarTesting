...
function TokenCard({
    ...
    return (
      <div className="bg-dark-gray text-white rounded-xl flex flex-col  group relative overflow-hidden">
          ...
          <div className="object-cover w-[350px] h-[260px] bg-gray-200 overflow-hidden">
            {nft.token.image != " " ? (
              <Image
                ...
                className="responsive transition-transform duration-500 ease-in-out transform hover:scale-110"
                width={350}
                height={260}
              />
            ) : (
