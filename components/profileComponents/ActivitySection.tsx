...
const ActivitySection = ({ id }: { id: string | undefined }) => {
                  ...
                  {filtersOpen?
                    ...
                    <div className="bg-black z-50 fixed left-0 block flex flex-col w-full h-screen  no-scrollbar">
                      ...
                      <div className="relative">
                        <div
                          className="border bg-black mt-8 mr-4 ml-4 rounded-sm flex justify-between cursor-pointer font-medium border-dark-gray-all h-10 text-sm pl-2 text-gray items-center whitespace-nowrap truncate pr-1"
                          onClick={() => {
