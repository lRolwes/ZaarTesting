...
var _chunkSSK5XXSKcjs = require('./chunk-SSK5XXSK.cjs');
...
var Oas = class _Oas {
  ...
  operation(path, method, opts = {}) {
    ...
    if (opts.isWebhook) {
      ...
      if (_optionalChain([api, 'optionalAccess', _7 => _7.webhooks, 'access', _8 => _8[path], 'optionalAccess', _9 => _9[method]])) {
        ...
        return new (0, _chunkSSK5XXSKcjs.Webhook)(api, path, method, operation);
      }
    }
    ...
    return new (0, _chunkSSK5XXSKcjs.Operation)(this.api, path, method, operation);
  }
  ...
  hasExtension(extension) {
    return _chunk6AZXSBHJcjs.hasRootExtension.call(void 0, extension, this.api);
  }
  /**
  ...
  getExtension(extension, operation) {
    return _chunk6AZXSBHJcjs.getExtension.call(void 0, extension, this.api, operation);
  }
  /**
  ...
  validateExtension(extension) {
    if (this.hasExtension("x-readme")) {
      ...
      if (extension in data) {
        if ([_chunk6AZXSBHJcjs.CODE_SAMPLES, _chunk6AZXSBHJcjs.HEADERS, _chunk6AZXSBHJcjs.PARAMETER_ORDERING, _chunk6AZXSBHJcjs.SAMPLES_LANGUAGES].includes(extension)) {
          if (!Array.isArray(data[extension])) {
            throw new TypeError(`"x-readme.${extension}" must be of type "Array"`);
          }
          if (extension === _chunk6AZXSBHJcjs.PARAMETER_ORDERING) {
            _chunk6AZXSBHJcjs.validateParameterOrdering.call(void 0, data[extension], `x-readme.${extension}`);
          }
    ...
    if (this.hasExtension(`x-${extension}`)) {
      ...
      if ([_chunk6AZXSBHJcjs.CODE_SAMPLES, _chunk6AZXSBHJcjs.HEADERS, _chunk6AZXSBHJcjs.PARAMETER_ORDERING, _chunk6AZXSBHJcjs.SAMPLES_LANGUAGES].includes(extension)) {
        ...
        if (extension === _chunk6AZXSBHJcjs.PARAMETER_ORDERING) {
          _chunk6AZXSBHJcjs.validateParameterOrdering.call(void 0, data, `x-${extension}`);
        }
   ...
   */
  validateExtensions() {
    Object.keys(_chunk6AZXSBHJcjs.extensionDefaults).forEach((extension) => {
  ...
  async dereference(opts = { preserveRefAsJSONSchemaTitle: false }) {
    ...
    if (api && api.components && api.components.schemas && typeof api.components.schemas === "object") {
      Object.keys(api.components.schemas).forEach((schemaName) => {
        if (_chunk5JRWN7L4cjs.isPrimitive.call(void 0, api.components.schemas[schemaName]) || Array.isArray(api.components.schemas[schemaName]) || api.components.schemas[schemaName] === null) {
          return;
        }
...
exports.Oas = Oas;
//# sourceMappingURL=chunk-H3JROHHI.cjs.map