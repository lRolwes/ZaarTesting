...
var _chunk5JRWN7L4cjs = require('./chunk-5JRWN7L4.cjs');


var _chunk6AZXSBHJcjs = require('./chunk-6AZXSBHJ.cjs');
...
function objectify(thing) {
  if (!_chunk5JRWN7L4cjs.isObject.call(void 0, thing)) {
    return {};
  }
  return thing;
}
...
function getMediaTypeExamples(mediaType, mediaTypeObject, opts = {}) {
  ...
  if (mediaTypeObject.schema) {
    if (!_chunk5JRWN7L4cjs.matches_mimetype_default.xml(mediaType)) {
      return [
        {
...
function getExampleGroups(operation) {
  ...
  const groups = {};
  const codeSamples = _chunk6AZXSBHJcjs.getExtension.call(void 0, "code-samples", operation.api, operation);
  _optionalChain([codeSamples, 'optionalAccess', _5 => _5.forEach, 'call', _6 => _6((sample) => {
...
var isJSON = _chunk5JRWN7L4cjs.matches_mimetype_default.json;
function buildHeadersSchema(response, opts) {
  ...
  Object.keys(headers).forEach((key) => {
    if (headers[key] && headers[key].schema) {
      ...
      headersSchema.properties[key] = _chunk5JRWN7L4cjs.toJSONSchema.call(void 0, header.schema, {
...
function getResponseAsJSONSchema(operation, api, statusCode, opts) {
  ...
  function getPreferredSchema(content) {
    ...
    for (let i = 0; i < contentTypes.length; i++) {
      if (isJSON(contentTypes[i])) {
        return _chunk5JRWN7L4cjs.toJSONSchema.call(void 0, _chunk5JRWN7L4cjs.cloneObject.call(void 0, content[contentTypes[i]].schema), {
          addEnumsToDescriptions: true,
          refLogger,
          transformer: opts.transformer
        });
    ...
    return _chunk5JRWN7L4cjs.toJSONSchema.call(void 0, _chunk5JRWN7L4cjs.cloneObject.call(void 0, content[contentType].schema), {
      addEnumsToDescriptions: true,
      refLogger,
      transformer: opts.transformer
    });
  ...
  if (foundSchema) {
    const schema = _chunk5JRWN7L4cjs.cloneObject.call(void 0, foundSchema);
    const schemaWrapper = {
      ...
      schema: _chunk5JRWN7L4cjs.isPrimitive.call(void 0, schema) ? schema : {
        ...schema,
        $schema: _chunk5JRWN7L4cjs.getSchemaVersionString.call(void 0, schema, api)
      },
      label: "Response body"
    };
...
var Operation = class {
  ...
  getContentType() {
    ...
    types.forEach((t) => {
      if (_chunk5JRWN7L4cjs.matches_mimetype_default.json(t)) {
        this.contentType = t;
      }
    });
    return this.contentType;
  ...
  isFormUrlEncoded() {
    return _chunk5JRWN7L4cjs.matches_mimetype_default.formUrlEncoded(this.getContentType());
  }
  isMultipart() {
    return _chunk5JRWN7L4cjs.matches_mimetype_default.multipart(this.getContentType());
  }
  isJson() {
    return _chunk5JRWN7L4cjs.matches_mimetype_default.json(this.getContentType());
  }
  isXml() {
    return _chunk5JRWN7L4cjs.matches_mimetype_default.xml(this.getContentType());
  }
  /**
  ...
  getOperationId(opts) {
    function sanitize(id) {
      return id.replace(_optionalChain([opts, 'optionalAccess', _31 => _31.camelCase]) ? /[^a-zA-Z0-9_]/g : /[^a-zA-Z0-9]/g, "-").replace(/--+/g, "-").replace(/^-|-$/g, "");
    }
    let operationId;
    ...
    if (_optionalChain([opts, 'optionalAccess', _32 => _32.camelCase])) {
   ...
   */
  getParameters() {
    let parameters = _optionalChain([this, 'access', _33 => _33.schema, 'optionalAccess', _34 => _34.parameters]) || [];
    const commonParams = _optionalChain([this, 'access', _35 => _35.api, 'optionalAccess', _36 => _36.paths, 'optionalAccess', _37 => _37[this.path], 'optionalAccess', _38 => _38.parameters]) || [];
  ...
  getParametersAsJSONSchema(opts = {}) {
    return _chunk5JRWN7L4cjs.getParametersAsJSONSchema.call(void 0, this, this.api, {
  ...
  getRequestBody(mediaType) {
    ...
    mediaTypes.forEach((mt) => {
      if (!availableMediaType && _chunk5JRWN7L4cjs.matches_mimetype_default.json(mt)) {
  ...
  getExtension(extension) {
    return _optionalChain([this, 'access', _39 => _39.schema, 'optionalAccess', _40 => _40[extension]]);
  }
  /**
...
var Callback = class extends Operation {
  ...
  getSummary() {
    if (_optionalChain([this, 'access', _41 => _41.schema, 'optionalAccess', _42 => _42.summary]) && typeof this.schema.summary === "string") {
      return this.schema.summary;
  ...
  getDescription() {
    if (_optionalChain([this, 'access', _43 => _43.schema, 'optionalAccess', _44 => _44.description]) && typeof this.schema.description === "string") {
      return this.schema.description;
...
var Webhook = class extends Operation {
  getSummary() {
    if (_optionalChain([this, 'access', _47 => _47.schema, 'optionalAccess', _48 => _48.summary]) && typeof this.schema.summary === "string") {
      return this.schema.summary;
  ...
  getDescription() {
    if (_optionalChain([this, 'access', _49 => _49.schema, 'optionalAccess', _50 => _50.description]) && typeof this.schema.description === "string") {
      return this.schema.description;
 ...
 */
//# sourceMappingURL=chunk-MAXKNYQ5.cjs.map