...
var _chunkMAXKNYQ5cjs = require('./chunk-MAXKNYQ5.cjs');
  ...
  operation(path, method, opts = {}) {
    ...
    if (opts.isWebhook) {
      ...
      if (_optionalChain([api, 'optionalAccess', _7 => _7.webhooks, 'access', _8 => _8[path], 'optionalAccess', _9 => _9[method]])) {
        ...
        return new (0, _chunkMAXKNYQ5cjs.Webhook)(api, path, method, operation);
      }
    }
    ...
    return new (0, _chunkMAXKNYQ5cjs.Operation)(this.api, path, method, operation);
  }
...
exports.Oas = Oas;
//# sourceMappingURL=chunk-F4NDWBVZ.cjs.map