...
var _chunkH3JROHHIcjs = require('../chunk-H3JROHHI.cjs');
require('../chunk-SSK5XXSK.cjs');
require('../chunk-VIIXOUMH.cjs');
require('../chunk-5JRWN7L4.cjs');
require('../chunk-6AZXSBHJ.cjs');
...
async function circularRefs(definition) {
  const oas = new (0, _chunkH3JROHHIcjs.Oas)(JSON.parse(JSON.stringify(definition)));
