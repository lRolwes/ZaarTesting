...
function getParametersAsJSONSchema(operation, api, opts) {
  ...
  const typeKeys = _chunk6AZXSBHJcjs.getExtension.call(void 0, _chunk6AZXSBHJcjs.PARAMETER_ORDERING, api, operation).map((k) => k.toLowerCase());
...
//# sourceMappingURL=chunk-5JRWN7L4.cjs.map